    ...
    <div class="nav">
        <div class="layout">
            ...
            <ul class="nav-list" id="nav-list">
                <li class="">
                    <a href="/account" target="UCenter">我的帐户</a>
                </li>
                <li class="bank">
                    <a href="/banks"  target="UCenter">银行充提</a>
                </li>
                <li class="bethistory">
                    <a href="/"  target="UCenter">投注记录</a>
                </li>
                <li class="repory">
                    <a href="#"  target="UCenter">帐户报表</a>
                </li>
                <li class="proxy">
                    <a href="/agent"  target="UCenter">代理管理</a>
                </li>
                <li class="culture">
                    <a href="/team"  target="UCenter">团队管理</a>
                </li>
                <li class="activity">
                    <a href="/integral"  target="UCenter">积分商城</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="leftmenu2">
                <ul class="lottery-list" id="lottery-list">
                    ...
                    <li id="s-3D">
                        ...
                        <a href="javascript:void(0)" class="desc"></a>
                        <button type="button" id="test">teset</button>
                    </li>
                </ul>
            </div>
        </div>
        <div class="content-info clearfix bet-panel">
            <iframe id="UCenter" name="UCenter" src="/test" style="width:950px; min-height:100" scrolling="no" frameborder="0" height="900"></iframe>
        </div>
    </div>
</body>
