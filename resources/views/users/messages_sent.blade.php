...
<div class="table-area">
    <h4 class="info-layout-title mt20">
        <span style="cursor:pointer;" onclick="window.location.href='/account/messages'" >已收信息(0)</span>
        <span style="cursor:pointer;" onclick="window.location.href='/account/messages-sent'" class="color-red ml20">已发信息(0)</span>
